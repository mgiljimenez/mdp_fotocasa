...
```{r}
# AFC SIMPLE : Property SubType vs Price
...
data$propertySubtypeCat <- subtype_map[as.character(data$propertySubtypeId)]
...
barplot(table(data$propertySubtypeCat), col = "lightgreen", main = "Distribución de priceAmount por Categorías")
...
contingency_table <- table(data$propertySubtypeCat, data$priceCategory)
